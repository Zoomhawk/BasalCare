    ...
    <div className="flex">
      ...
      <div className="grid w-2/3 h-screen border-solid border-2 gap-2">
        <div className="grid grid-rows-3 grid-flow-col gap-2">
          <div className="row-span-3 col-span-2 border-solid border-2">
            <strong>Previous Details:</strong>
            <li>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque,
              delectus voluptates. Impedit sequi numquam, distinctio similique
              iusto dolorem iste omnis dolores facilis esse aperiam consectetur
              neque voluptates ullam quisquam ab odit illo. Quibusdam, dolores.
            </li>
          </div>
